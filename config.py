...
class Config:
    ...
    ADMINS = [5606017879, 6012752629, 5140314109, 5558249587, 895822435]
    DB_URL = "mongodb+srv://tyagidevbhai:tyagidev999@cluster0.ndzfhmv.mongodb.net/?retryWrites=true&w=majority"                    
    DB_NAME = "main"
